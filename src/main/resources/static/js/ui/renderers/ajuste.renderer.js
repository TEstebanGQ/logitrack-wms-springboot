/**
 * Renderizador de Ajustes de Inventario y Mermas
 */
export const ajusteRenderer = {
  renderTabla: (ajustes) => {
    const tbody = document.getElementById('tabla-ajustes-body');
    if (!tbody) return;

    if (!ajustes || ajustes.length === 0) {
      tbody.innerHTML = '<tr><td colspan="10" class="text-center py-4">No hay registros de ajustes o mermas.</td></tr>';
      return;
    }
